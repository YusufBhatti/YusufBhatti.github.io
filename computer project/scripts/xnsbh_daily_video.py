...
files = sorted(glob.glob('E://Data Files (NetCDF)/'+expname+'/Daily_AOD/*.nc'))
...
### Looping the variables needed to be extracted for the different days ###
for file in files:
    vn=Dataset(file)
...
### Save and display the plot as a .png and save in high quality (dpi=600)###
    plt.savefig("E://Model_Plots/xnsbh/daily_video/" +expname+"_"+sdate[0:10]+".png",bbox_inches = 'tight')
...
png_dir = 'E://Model_Plots/xnsbh/daily_video/'
images = []
...
imageio.mimsave('E://Model_Plots/xnsbh/daily_video/daily_10.gif', images,**kargs)