...
### To access months for the plot, layout is: year (0,1),month (10,11,12,...) 
mnames=['0sep','0oct','0nov','0dec','1jan','1feb','1mar',
        '1apr','1may','1jun','1jul','1aug','1sep','1oct',
        '1nov']
...
### Add title ###
    plt.title("20 Tg SO$_2$ @ 21-23 km height"+" ("+sdate[0:10]+")",fontsize=20)
    
### Save and display the plot ###
    plt.savefig("E://Model_Plots/xnsbi_20/Monthly_AOD/" +expname+"_"+sdate[0:10]+".png",bbox_inches = 'tight')
...
png_dir = 'E://Model_Plots/xnsbi_20/Monthly_AOD/'
images = []
...
imageio.mimsave('E://Model_Plots/xnsbi_20/Monthly_AOD/monthly_20.gif', images,**kargs)